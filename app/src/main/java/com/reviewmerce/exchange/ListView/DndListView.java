...
public class DndListView extends ListView {
    ...
    public void setDragAvalablePerc(double dragAvalablePerc) {
        this.mDragAvalablePerc = dragAvalablePerc;
    }

    private double mDragAvalablePerc;
...
//                    Log.d("Itemnum", "" + itemnum);
                    ...
                    View dragger =item.findViewById(R.id.item_layout_edit);

                    Rect r = mTempRect;
                    dragger.getDrawingRect(r);
                    if((mDragAvalablePerc <= .0f) || (x < r.width()*mDragAvalablePerc)){
                        break;
                    }
                    if (x < r.right * 2) {
...
//                        Log.d("onInterceptTouchEvent", "UpperBound  :  " + mUpperBound + "    //    LowerBound  :  " + mLowerBound);
    ...
    private int myPointToPosition(int x, int y) {
        ...
        for (int i = count - 1; i >= 0; i--) {
            ...
            if (frame.contains(frame.centerX(), y)) {
