...
public class BankView extends LinearLayout {
 ...
 //   private TextView mText02;
  ...
  //  private TextView mText03;
    ...
    public BankView(Context context, BankItem aItem) {
        super(context);

        // Layout Inflation
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.fragment_list_bank, this, true);
...
//        mIcon.setScaleType(ImageView.ScaleType.FIT_CENTER);
        // Set Text 01
        mText01 = (TextView) findViewById(R.id.tvIndex);
        mText01.setText(aItem.getData(0));

        mText02 = (TextView) findViewById(R.id.tvBank);
        mText02.setText(aItem.getData(1));

        mText03 = (TextView) findViewById(R.id.tvValue);
